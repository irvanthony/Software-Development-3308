...
//for(let i = 0; i < 4; i++ )
{
	var la = state_info[key]['lat'];
	var ln = state_info[key]['lng'];
	var u = "https://api.darksky.net/forecast/360e00e6ab52efc331f4f5f9f3f5d5b3/" + la +  "," + ln;
	$.ajax({url: u, dataType: "jsonp"}).then(function(data)
	{
		//alert(data);
